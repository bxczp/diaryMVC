...
<!--核心JavaScript文件-->
<script
	src="${pageContext.request.contextPath}/bootstrap3/js/bootstrap.js"></script>
		...
		<div class="navbar-inner">
			<div class="container">
				...
				<div class="nav-collapse collapse">
					<ul class="nav">
						<li class="active"><a href="${pageContext.request.contextPath }/main/all.do?all=true"><i
								class="icon-home"></i>&nbsp;主页</a></li>
						<li class="active"><a href="${pageContext.request.contextPath }/diary/preSave.do"><i
								class="icon-pencil"></i>&nbsp;写日记</a></li>
						<li class="active"><a href="${pageContext.request.contextPath }/diaryType/list.do"><i
								class="icon-book"></i>&nbsp;日记分类管理</a></li>
						<li class="active"><a href="${pageContext.request.contextPath }/user/preSave.do"><i
								class="icon-user"></i>&nbsp;个人中心</a></li>
					</ul>
				</div>
				<!-- 搜索表单 -->
				<form name="myForm" class="navbar-form pull-right" method="post"
					action="${pageContext.request.contextPath }/main/all.do?all=true">
					...
					<div class="datas">
						<ul>
							<c:forEach var="diaryTypeCount" items="${diaryTypeCountList }">
								<li><span> <a
										href="${pageContext.request.contextPath }/main/all.do?diary_typeId=${diaryTypeCount.diaryTypeId }">${diaryTypeCount.typeName }(${diaryTypeCount.diaryCount })</a>
								</span></li>
							</c:forEach>
						</ul>
					</div>
					...
					<div class="datas">
						<ul>
							<c:forEach var="diaryCount" items="${diaryCountList }">
								<li><span> <a
										href="${pageContext.request.contextPath }/main/all.do?diary_releaseDateStr=${diaryCount.releaseDateStr }">${diaryCount.releaseDateStr }(${diaryCount.diaryCount })</a>
								</span></li>
							</c:forEach>
						</ul>
					</div>
